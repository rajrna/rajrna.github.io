  ...
  return (
    <section className="mx-auto flex max-w-5xl flex-col items-center justify-center px-4 pl-4 md:px-0 md:pl-64">
      <div className="mt-10 md:mt-15">
        <div className="text-off-red text-xl md:text-2xl">
          Hey, I am
        </div>
        <h1>
          Raj Rana{' '}
          <span className="text-off-red">.</span>
        </h1>
        <p>
        ...
        <p>
          ...
          and rapidly adapting to new
          technologies.
          <br />
          When I'm not coding I immerse myself in
          design, digital art and story-telling.
        </p>
        <p>
          I am always seeking for exciting
